#!/usr/bin/env bash
# tests/fm-jev-fastpath-guard.test.sh - Regression tests for Pattern 197 (TCP Fast-Path Guard)
set -euo pipefail
...
echo "Running Pattern 197 regression tests..."
...
echo "Pattern 197 regression tests passed: 6/6 tests ok"
