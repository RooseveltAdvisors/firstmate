...
test_ci_step_does_not_hide_a_gone_endpoint
test_ci_transition_at_shared_wedge_boundary
for d in "$TMP_ROOT"/ci-*; do [ -f "$d/watch.out" ] || continue; printf "\nCASE %s\n" "${d##*/}"; cat "$d/watch.out"; done > "/home/jon/.no-mistakes/evidence/01M331WRGZH34NEA90N07XDG81/watcher-transcript.txt"
