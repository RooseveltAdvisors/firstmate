...
test_top_level_fixing_ci_running_after_green_stays_working
test_ci_monitoring_still_waiting_stays_working
run_crew_state "$TMP_ROOT/ci-waiting" feat-ciwait > /home/jon/.no-mistakes/evidence/01M331WRGZH34NEA90N07XDG81/crew-state-transcript.txt
FM_FAKE_AXI_STATUS="$(run_top_level_ci fm/feat-ciwait)"
run_crew_state "$TMP_ROOT/ci-waiting" feat-ciwait > /home/jon/.no-mistakes/evidence/01M331WRGZH34NEA90N07XDG81/crew-state-top-level-ci.txt
