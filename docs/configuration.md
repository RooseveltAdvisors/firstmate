...
FM_SECONDMATE_IDLE_STALE_SECS=2700 # seconds an evergreen secondmate's pane may sit unchanged before it surfaces as a stopped standing loop; a ping-model secondmate stays exempt however long it idles
