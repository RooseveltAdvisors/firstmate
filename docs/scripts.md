...
| `fm-fleet-view.sh`       | Render the fleet snapshot and blocked Beads as a human Markdown view                 |
| `fm-evolve-loop.sh`      | Run the graph-of-loops pass and project stalled or drifting findings into `watch-loop` Beads |
