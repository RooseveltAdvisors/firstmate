...
A script with no hint gets the conservative `PORTABLE_SERIAL_DEFAULT_WEIGHT_MS` default; the current 157-script lane has twelve such scripts, bringing its assignment weight to 4636606 ms.
...
It happened again on PR 3934: the hints were still the 2026-09-01 maxima, the lane had grown to 152 scripts and ~79 minutes, and several refreshed maxima came in 2-6x above their stale hints, so shard 4 of 5 was cancelled at the 20-minute job cap while the other shards finished in 12.5-16.5 minutes.
...
| Lane | Script count | Estimated duration |
|---|---:|---:|
| `portable-serial-1of5` | 32 | 927318 ms (~15.46 min) |
| `portable-serial-2of5` | 31 | 927312 ms (~15.46 min) |
| `portable-serial-3of5` | 32 | 927329 ms (~15.46 min) |
| `portable-serial-4of5` | 32 | 927326 ms (~15.46 min) |
| `portable-serial-5of5` | 30 | 927321 ms (~15.46 min) |
| imbalance | | 17 ms |
