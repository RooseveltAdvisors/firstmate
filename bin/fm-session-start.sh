...
#                       secondmate liveness, pending remote
...
#             liveness, endpoint-binding migration, pending remote handoff
#             retry, X-mode artifact writes) - and
...
if [ "$REEMIT" -eq 1 ]; then
  ...
  printf 'secondmate convergence and liveness, endpoint-binding migration,\n'
  printf 'pending remote handoff\n'
...
if [ "$LOCK_RC" -ne 0 ]; then
  ...
  BAR='●━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'
  {
    ...
    printf '●  %s\n' "$LOCK_OUT"
    printf '●  Skipping every mutating step: endpoint-binding migration,\n'
    printf '●  stale Herdr child cleanup,\n'
