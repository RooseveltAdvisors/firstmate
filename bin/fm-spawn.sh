...
# keeps no data/backlog.md. A configured non-markdown adapter remains active
# without that file; any active automatic backend without compatible tasks-axi
# refuses before creating lifecycle state.
