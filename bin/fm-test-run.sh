...
family_for_basename() {
  case "$1" in
    ...
    fm-operational-input.test.sh|fm-pi-beads-enforcement.test.sh|fm-pi-primary-types.test.sh|\
...
families_for_changed_path() {
  ...
  case "$path" in
    ...
    .pi/extensions/fm-primary-turnend-guard.ts|.pi/extensions/beads-enforcement.ts)
